...
const ShowCase2 = () => {
    ...
    return (
            ...
            <div className="mt-16 grid grid-cols-2 gap-11">
                ...
                <div className="p-5">
                    <h1 className="text-2xl font-semibold">Forest Lounge</h1>
                    ...
                    <a className="flex items-center gap-1 bg-yellow-400 font-semibold p-2 rounded-xl" href="https://github.com/ibrahimRabbi/forest-lounge-client"><FaGithub />Client side code</a>
                    <a className="flex items-center gap-1 bg-yellow-400 font-semibold p-2 rounded-xl" href="https://github.com/ibrahimRabbi/forest-lounge-server"><FaGithub />Server side code</a>
                        <a className="flex items-center gap-1 bg-yellow-400 font-semibold p-2 rounded-xl" href="">Live Demo <MdTravelExplore /></a>
                    </div>
                </div>
